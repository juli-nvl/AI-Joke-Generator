...
function getJoke(event) {
  ...
  let apiContext =
    "You are a joke expert and love to write short jokes of all topics. Your mission is to generate a joke following the user instructions. Add a </br> after the joke and sign it with 'SheCodes AI' inside a <strong> element at the end of the joke";
